...
def whatsapp():
    ...
    if "hello" in incoming_msg:
        ...
        msg.body("\n1. 2 BHK - ₹65 lakh - Andheri East")
        msg.body("2. 2 BHK - ₹68 lakh - Borivali")
        msg.body("3. 2 BHK - ₹62 lakh - Malad")
        msg.body("\nEach property includes:")
        msg.body("• Modern amenities 🏗️")
        msg.body("• Security system 🔒")
        msg.body("• Parking space 🚗")
        ...
        msg.body("\n1. 3 BHK - ₹85 lakh - Andheri East")
        msg.body("2. 3 BHK - ₹88 lakh - Borivali")
        msg.body("3. 3 BHK - ₹82 lakh - Malad")
        msg.body("\nEach property includes:")
        msg.body("• Modern amenities 🏗️")
        msg.body("• Security system 🔒")
        msg.body("• Parking space 🚗")
        msg.body("\nWant more details about any of these? Just reply with the number!")
        msg.body("\nType 'back' to return to previous menu or 'help' for assistance.")
    elif "visit" in incoming_msg or "3" in incoming_msg:
        msg.body("Would you like to schedule a property visit? 📅")
        msg.body("\nPick a time slot:")
        ...
        msg.body("\nWould you like to:")
        msg.body("1. Confirm booking")
        msg.body("2. Reschedule")
        msg.body("3. Cancel")
        msg.body("\nType your choice or 'back' to return to main menu.")
